...
/**
 * Class PH2M_PhOptimizations_Model_Override_Catalog_Product
 */
class PH2M_PhOptimizations_Model_Override_Catalog_Product extends Mage_Catalog_Model_Product
{
    /**
     * @inheritDoc
     */
    ...
    {
        $cacheId    = 'MODEL_CATALOG_PRODUCT_' . $id . '_' . $field . '_STORE_' . Mage::app()->getStore()->getId();
