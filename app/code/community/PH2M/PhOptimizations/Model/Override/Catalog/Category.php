...
/**
 * Class PH2M_PhOptimizations_Model_Override_Catalog_Category
 */
class PH2M_PhOptimizations_Model_Override_Catalog_Category extends Mage_Catalog_Model_Category
{
    /**
     * @inheritDoc
     */
    ...
    {
        $cacheId    = 'MODEL_CATALOG_CATEGORY_' . $id . '_' . $field . '_STORE_' . Mage::app()->getStore()->getId();
